		...
		<div class="container">
			...
			<div class="d-md-none">
				<div class="table-responsive-md">
					<table class="table table-hover table-responsive-md table-striped text-start">
						<?php include("maintanenceViewSingleActiveTicketTableSmall.php") ?>
					</table>
				</div>
			</div>
