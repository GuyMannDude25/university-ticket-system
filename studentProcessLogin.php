...
// email/password combination
 $query = "SELECT idNum, password, firstName, lastName, userLevel, roomNum, profilePic FROM students ";
 $query .= "WHERE email=?";
...
if ($password === $row[1]) {	//#2
	...
	//Check if the student has a room
		...
		// destroy the session
			...
			$errors[] = 'No room registration was found';
			$errors[] = 'Perhaps you need to register ';
			$errors[] = 'or registration is processing ';
