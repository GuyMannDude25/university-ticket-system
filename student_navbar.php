<!-- Navigation Bar -->
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar">
					<ul class="navbar-nav">
						<li class="nav-item">
							<a class="nav-link" href="student_view_my_tickets_page.php">My Tickets</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="student_new_ticket_page.php">New Ticket</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="offcanvas-body">
			...
			<p>Room Number: <?php echo $_SESSION['roomNum']; ?></p>
		<!--Logout Button -->
